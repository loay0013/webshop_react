...
import { removeFromCart, updateCartItemQuantity } from "../../features/slices/cartSlice"; // Opdater stien efter behov
...
const Cart = ({ openModal, setOpen }) => {
    ...
    const handleQuantityChange = (item, delta) => {
        ...
        if (newQuantity > 0) {
            ...
            // Opdateret til kun at bruge id, da size og color er fjernet
